...
// identifiers off to the client `<ListView />`. The project header sits
// one level up in `layout.tsx`; this route only owns the filter chip bar
// and the table body.
...
export default async function ProjectListView({ params }: ListPageProps) {
